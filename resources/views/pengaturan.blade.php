...
<div class="max-w-2xl mx-auto">
    <h1 class="text-3xl font-extrabold text-[#0A193F] mb-8">Pengaturan Akun</h1>
    ...
    <form action="{{ route('pengaturan.update') }}" method="POST" class="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6">
        ...
        {{-- Nama & NPSN (Ganti dari sebelumnya) --}}
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                {{-- NPSN tidak bisa diubah karena merupakan identitas unik sekolah --}}
        ...
        <div class="pt-4">
            <button type="submit" class="w-full md:w-auto bg-[#0A193F] text-white px-8 py-3 rounded-xl font-bold hover:bg-slate-800 transition shadow-lg">
                Simpan Perubahan
            </button>
        </div>
    </form>
